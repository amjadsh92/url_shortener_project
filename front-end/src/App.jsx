...
function App() {
  ...
  return (
    <div className="bg-hero w-full h-full p-1px">
      ...
      <div className="title">
        <h1 className="text-center text-white mt-100px text-5xl">URL Shortener App</h1>
        <h1 className="text-center text-white mt-5 ">Build stronger digital connections</h1>
    ...
    >
        ...
        <AutoComplete value={originalURL} field="label" optionGroupLabel="label" optionGroupChildren="items" placeholder="https://www.example.com/my-long-url" onChange={handleOriginalURLChange} required/>

        <p className="url font-semibold mb-2">Create your own short url</p>
        <AutoComplete value={shortURL}  field="label" optionGroupLabel="label" optionGroupChildren="items" placeholder="my-short-url" onChange={handleShortURLChange}/>

        <Button className="mt-4" icon="pi pi-arrow-right" iconPos="right" label="Get your link for free" />
        </form>
